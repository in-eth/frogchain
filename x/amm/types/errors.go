...
var (
	...
	ErrDeadlinePassed    = sdkerrors.Register(ModuleName, 1108, "deadline is passed")
	...
	ErrInvalidAssets     = sdkerrors.Register(ModuleName, 1111, "invalid assets")
	ErrDuplicateAssets   = sdkerrors.Register(ModuleName, 1112, "duplicate assets")
	ErrInvalidLength     = sdkerrors.Register(ModuleName, 1113, "invalid assets length")
	ErrUnderMinAmount    = sdkerrors.Register(ModuleName, 1114, "swaped value is under min amount")
	ErrInvalidSwapAmount = sdkerrors.Register(ModuleName, 1115, "swap amount is exceed pool token balance")
)
