...
var (
	filter_Query_InterchainAccount_0 = &utilities.DoubleArray{Encoding: map[string]int{"connectionId": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	...
	pattern_Query_InterchainAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"frogchain", "investibc", "interchain_account", "connectionId"}, "", runtime.AssumeColonVerbOpt(true)))
)
