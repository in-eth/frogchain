...
frogchaind tx amm swap-exact-tokens-for-tokens [pool-id] [amount-in] [amount-out-min] [path] [to] [deadline]
frogchaind tx amm swap-tokens-for-exact-tokens [pool-id] [amount-out] [path] [to] [deadline]